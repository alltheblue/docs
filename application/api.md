...
市面上的接口关联测试，对测试人员的编码能力有一定的要求，导致很多测试人员对测试望而却步，测试效率下降，很难提高生产效率，而且无法了解线上运行的项目的稳定性，这就加大了对线上运行的项目的不确定性，而集成测试中的 api 可以满足日常 api 测试的需求，而且对测试人员的编码能力无要求，真正做到了 GUI 测试，配合定时任务的使用，可以随时随地了解线上运行环境，真正做到了如指掌。
